...
export default function EmployerApplicationsContent() {
  ...
  const [applicationsData, setApplicationsData] =
    useState<ApplicationsData | null>(null);
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        >
          <div
            className={`h-10 w-10 rounded-full bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center ${
          ...
          <div className={language === "ar" ? "text-right" : "text-left"}>
            ...
            <p className="text-sm text-gray-500">
              ...
              {t("dashboard.totalApplicationsReceived")}
            </p>
          </div>
        </div>
      </div>
        ...
        {[
          {
            ...
            value: applicationsData?.by_status.pending || 0,
            color: "text-yellow-600",
            bg: "bg-yellow-50",
          },
          {
            label: t("dashboard.reviewed"),
            value: applicationsData?.by_status.reviewed || 0,
            color: "text-blue-600",
            bg: "bg-blue-50",
          },
          {
            label: t("dashboard.interviewScheduled"),
            value: applicationsData?.by_status.interview_scheduled || 0,
            color: "text-purple-600",
            bg: "bg-purple-50",
          },
          {
            label: t("dashboard.hired"),
            value: applicationsData?.by_status.hired || 0,
            color: "text-green-600",
            bg: "bg-green-50",
          },
          {
            label: t("dashboard.rejected"),
            value: applicationsData?.by_status.rejected || 0,
            color: "text-red-600",
            bg: "bg-red-50",
          },
        ].map((stat) => (
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1">
            <form onSubmit={handleSearch} className="relative">
              ...
              <input
                ...
                placeholder={t("dashboard.searchCandidatesJobTitles")}
              />
            </form>
          </div>
          ...
          >
            ...
            >
              ...
              <option value="hired">{t("dashboard.hired")}</option>
          ...
          <div className="text-center py-12 bg-white rounded-lg shadow">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {searchTerm || selectedStatus !== "all"
                ...
                : t("dashboard.applicationsWillAppear")}
            </p>
          </div>
        )}
      </div>
