                    ...
                    <div>
                      ...
                      {isEmployer ? (
                        <p className="text-sm text-gray-500">
                          {language === 'en' ? 'Email' : 'البريد الإلكتروني'}: {(item as EmployerRecentItem).email}
                        </p>
                      ) : (
                        <p className="text-sm text-gray-500">
                          {language === 'en' ? 'Status' : 'الحالة'}: {(item as EmployeeRecentItem).status}
                        </p>
                      )}
                    </div>
                  </div>
