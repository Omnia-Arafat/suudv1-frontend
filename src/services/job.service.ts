...
class JobService {
   ...
   */
  async getJobs(params?: JobSearchParams): Promise<PaginatedResponse<JobListing>> {
   ...
   */
  async updateJob(id: number, jobData: UpdateJobListingRequest): Promise<JobListing> {
   ...
   */
  async getMyJobs(params?: JobSearchParams): Promise<PaginatedResponse<JobListing>> {
    const response = await apiClient.get<PaginatedResponse<JobListing>>('/jobs/my-jobs', {
      params,
    });
